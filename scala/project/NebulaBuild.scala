...
object NebulaBuild extends Build {
  ...
  def extraTestFrameworks = Seq( //    testFrameworks += new TestFramework("org.scalameter.ScalaMeterFramework")
  )
  ...
  //      "com.github.axel22" %% "scalameter" % "0.3",
        ...
        "org.scalatest" %% "scalatest" % "2.0.M6-SNAP9",
